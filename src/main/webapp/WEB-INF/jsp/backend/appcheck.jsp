...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>查看并审核APP信息
                    <small><i class="fa fa-user"></i>${backUser.userName}</small>
                </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_title">
            ...
            <div class="x_content1">
                <form class="form-horizontal form-label-left" id="checkFrom" action="" method="post">
                    <input type="hidden" name="id" id="aid" value="${appInfo.id}">
                  ...
                  ${appInfo.appInfo}</textarea>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <img src="/statics/uploadFiles/${appInfo.logoPicPath }" width="100px;"/>
                                </c:otherwise>
                            </c:choose>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                            <button id="statu" type="button" name="status" value="2" class="btn btn-success">审核通过
                            </button>
                            <button id="status" type="button" name="status" value="3" class="btn btn-success">审核不通过
                            </button>
                            <button type="button" class="btn btn-primary" onclick="javascript:history.back()" id="back">
                                返回
                            </button>
                        </div>
                    </div>
            ...
            <div class="x_content" style="display: block;">
                ...
                <form class="form-horizontal form-label-left">
                    <c:forEach items="${appInfo.appVersion}" var="appVersion">
                        <c:if test="${appInfo.versionId==appVersion.id}">
                            <div class="item form-group">
    ...
    <script src="/statics/localjs/backend/AppCheck.js"></script>