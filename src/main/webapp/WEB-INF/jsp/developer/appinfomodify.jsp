  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" id="appEdit" action="" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" id="id" value="${appInfo.id}">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">软件名称 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="appName" class="form-control col-md-7 col-xs-12"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="viewLanguage" class="form-control col-md-7 col-xs-12"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="appSize" name="softwareSize" value="${appInfo.softwareSize}" required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="loadCount" name="downloads" value="${appInfo.downloads}" required="required"
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				<input type="hidden" id="logoPicPath" name="logoPicPath" value="/statics/uploadFiles/${appInfo.logoPicPath}"/>
                <input type="hidden" id="oldPhoto" name="oldPhoto" value="${appInfo.logoPicPath}"/>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">修改图片 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="photo" type="file" class="form-control col-md-7 col-xs-12"
                     name="photo" value=""/>
              <font style="color: red"></font>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
            	<c:if test="${appInfo.status == 3}">
            	 	<button id="againSend" type="submit" name="status" value="1" class="btn btn-success">保存并再次提交审核</button>
            	</c:if>
              <button id="send" type="button" value="0" class="btn btn-success">保存</button>
...
<script src="${pageContext.request.contextPath }/statics/localjs/deve/appinfomodify.js"></script>
