  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <form class="form-horizontal form-label-left" id="editVersionForm" action="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
              <button id="sendEditVersion" type="button" class="btn btn-success">保存</button>
...
<script src="${pageContext.request.contextPath }/statics/localjs/deve/appversionmodify.js"></script>
