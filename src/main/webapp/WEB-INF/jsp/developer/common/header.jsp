...
<body class="nav-md footer_fixed">
	<div class="container body">
		<div class="main_container">
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="/sys/appInfo/main" class="site_title"><i class="fa fa-paw"></i> <span>APP
								BMS</span>
						</a>
					</div>
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP账户管理 <span
									...
									<ul class="nav child_menu">
										<li><a href="/sys/devUser/toAddUser">APP开发者账户申请</a>
										</li>
										<li><a href="/sys/devUser/toEditUser">个人账户信息维护</a>
										</li>
									</ul></li>
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="/sys/devUser/appList.html">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
			...
			<!-- /top navigation -->
			<div class="right_col col-md-10 col-sm-10 col-xs-10" role="main">
				<div class="x_content">
