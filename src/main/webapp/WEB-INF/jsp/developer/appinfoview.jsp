            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			 <c:choose> 
				  ...
				  <c:otherwise>
				    ...
				    <%--<img src="/statics/uploadFiles/${appInfo.logoPicPath }?m=1" width="100px;"/>--%>
				  </c:otherwise> 
              </c:choose> 
            </div>
          </div>
			...
			<div class="row">
				<div class="col-sm-12">
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
						...
						<tbody>
							<c:forEach var="appVersion" items="${appInfo.appVersion}" varStatus="status">
...
<script src="${pageContext.request.contextPath }/statics/localjs/deve/appinfoview.js"></script>